...
<option value="">Русский</option>
  ...
  <div id="nav" className=" sticky  container-fluid bg-light text-dark shadow p-3 mb-5 bg-body-tertiary rounded">
...
<Row>
       ...
       <li><a   id="drop"  class="dropdown-item" href="#"> Student Stories</a></li>
            ...
            <li><a id="drop" className="dropdown-item " href="/student">Getting Ready</a></li>
            <li><a id="drop1"className="para" href="student">Learn more about the test and how to prepare</a></li>
